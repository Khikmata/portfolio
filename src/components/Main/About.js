					...
					<div className={styles[`aboutme__card__container__right${props.scrollPos > 750 && props.scrollPos < 950 ? '__active' : ''}`]}>
						<div className={styles.aboutme__card__item}>
							<div className={styles[`aboutme__card__item__right${props.scrollPos >= 750 && props.scrollPos < 950 ? '__active' : ''}`]}>
								<p>Worked for <span>over 1 year </span>  as a layout designer and a frontend developer</p>
							</div>
						</div>
						<div className={styles[`aboutme__card__item__background__right${props.scrollPos > 750 && props.scrollPos < 950 ? '__active' : ''}`]}></div>
					</div>
					<div className={styles[`aboutme__card__container__left${props.scrollPos > 950 && props.scrollPos < 1100 ? '__active' : ''}`]}>
						<div className={styles.aboutme__card__item}>
							<div className={styles[`aboutme__card__item__left${props.scrollPos >= 950 && props.scrollPos < 1100 ? '__active' : ''}`]}>
								<p> Was an <span>UI designer </span> before</p>
							</div>
						</div>
						<div className={styles[`aboutme__card__item__background__left${props.scrollPos > 950 && props.scrollPos < 1100 ? '__active' : ''}`]}></div>
					</div>
