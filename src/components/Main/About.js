		...
		<>
			...
			<div className={styles.content__aboutme}>
				<div >
					...
					<div className={styles[`aboutme__card__container__left${props.scrollPos > 950 && props.scrollPos < 1150 ? '__active' : ''}`]}>
						<div className={styles.aboutme__card__item}>
							<div className={styles[`aboutme__card__item__left${props.scrollPos >= 950 && props.scrollPos < 1150 ? '__active' : ''}`]}>
								<p> Was an <span> </span> before</p>
							</div>
						</div>
						<div className={styles[`aboutme__card__item__background__left${props.scrollPos > 950 && props.scrollPos < 1150 ? '__active' : ''}`]}></div>
					</div>
